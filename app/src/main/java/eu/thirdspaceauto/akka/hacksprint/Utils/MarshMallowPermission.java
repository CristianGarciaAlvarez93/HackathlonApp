package eu.thirdspaceauto.akka.hacksprint.Utils;
...
public class MarshMallowPermission extends Activity {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        switch (requestCode) {
            ...
            case 3:
                if (grantResults.length <= 0 || grantResults[0] != 0) {
                    Log.d(TAG, "Read Sms Permission Denied");
                    return;
                } else {
                    Log.d(TAG, "Read SmsPermission granted");
                    return;
                }
            case 4:
                if (grantResults.length <= 0 || grantResults[0] != 0) {
            ...
            case 6:
                if (grantResults.length <= 0 || grantResults[0] != 0) {
                    Log.d(TAG, "Read Phone Call logs Permission Denied");
                    return;
                } else {
                    Log.d(TAG, "Read Phone Call logs Permission granted");
                    return;
                }
            case 7:
                if (grantResults.length <= 0 || grantResults[0] != 0) {
                    Log.d(TAG, "Read CalendarData logs Permission Denied");
                    return;
                } else {
                    Log.d(TAG, "Read CalendarData Permission granted");
                    return;
                }
            case 8:
                if (grantResults.length <= 0 || grantResults[0] != 0) {
                    Log.d(TAG, "Receive  Sms Permission Denied");
                    return;
                } else {
                    Log.d(TAG, "Receive SmsPermission granted");
                    return;
                }
            case 9:
                if (grantResults.length <= 0 || grantResults[0] != 0) {
                    Log.d(TAG, "Write to Calendar Permission Denied");
                    return;
                } else {
                    Log.d(TAG, "Write to Calendar granted");
                    return;
                }
            case 10:
                if (grantResults.length <= 0 || grantResults[0] != 0) {
                    Log.d(TAG, "Write to Contacts Permission Denied");
                    return;
                } else {
                    Log.d(TAG, "Write to Contacts granted");
                    return;
                }

            case 11:
                if (grantResults.length <= 0 || grantResults[0] != 0) {
                    Log.d(TAG, "Access location Permission Denied");
                    return;
                } else {
