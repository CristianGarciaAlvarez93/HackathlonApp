...
public class TrackLinkFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        left_link_pitch_image = (ImageView) rootView.findViewById(R.id.left_link_pitch_image);
        right_link_pitch_image= (ImageView) rootView.findViewById(R.id.right_link_pitch_image);
